...
// Vires is the primary surface (root redirects there). Ops + Trading + Bench +
// Queue stay reachable but Vires leads in both desktop top nav and mobile
// bottom nav so the daily hub is always one tap away.
const LINKS = [
